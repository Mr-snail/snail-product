...
MAIN_CLASS=com.snail.product.service.SnailProductServiceApplication

CLASSPATH=$APP_HOME/current/config:$APP_HOME/frontend_templates:$APP_HOME/current/lib/*
...
start(){
    ...
    echo "nohup $JAVA_HOME/bin/java $JAVA_OPTS -classpath $CLASSPATH $MAIN_CLASS"
